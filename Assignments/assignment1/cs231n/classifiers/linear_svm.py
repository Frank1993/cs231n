...
def svm_loss_vectorized(W, X, y, reg):
  ...
  margin = scores- correct_class_scores.reshape(correct_class_scores.shape[0],-1) +1 # delta is 1
  ...
  dscores[np.arange(scores.shape[0]),y] = -num_pos

  dW = X.T.dot(dscores) / X.shape[0] + reg * W
  #############################################################################
  #                             END OF YOUR CODE                              #
  #############################################################################
